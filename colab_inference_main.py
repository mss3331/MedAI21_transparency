...
if __name__ == '__main__':
    ...
    checkpoint = torch.load('./GIANA21/checkpoints/highest_IOU_Deeplabv3_GRU_ASPP_resnet50.pt')
    ...
    subDirs = ['CVC-612', 'CVC-ClinicHDSegment']
    subDirs = ['CVC-ClinicHDSegment']
    for j in range(0, len(subDirs)):

        # ---> Folder for test data location!!! (Warning!!! do not copy/visulise!!!)
        imgfolder = '/content/' + subDirs[j]
